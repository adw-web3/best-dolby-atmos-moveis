...
def write_markdown(ranked, path, top_n=100):
    lines = [
        f"# Top {top_n} Dolby Atmos Movies",
        "",
        f"*Auto-generated by [`scoring/score.py`](../scoring/score.py) from {len(ranked)} distinct films across all sources. Do not hand-edit.*",
        "",
...
def main():
    ...
    write_markdown(ranked, md_path, top_n=100)
